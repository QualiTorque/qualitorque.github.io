...
* [Remove a space blueprint](#remove-a-space-blueprint)
...
## Remove a space blueprint
As we discussed earlier, there are two types of blueprints, autogenerated blueprints (those residing in Torque) and blueprints residing in YAML files in your repository. 
...
And to remove a repository blueprint, delete the blueprint file from the repository.