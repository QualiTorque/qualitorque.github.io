...
The Torque application requests full access to your repositories. However, the Torque application is **read only** and will never write to your repositories.
